...
public class ReadyPlayer2 {

    /**
     * this is for player 2 - Intelligent One
     */
    public static void main(String[] args) {
        // todo chapter 1 creation
        //  create yourself a new hero with an epic name (an instance of class Hero)
        //  your hero is really smart, so find a way to define Intelligence for your hero
        //  add intelligence to your hero
        ...
        // create a method to train intelligence (your teammates will create other methods)
