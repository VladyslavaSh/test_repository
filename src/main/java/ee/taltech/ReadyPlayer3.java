...
public class ReadyPlayer3 {

    /**
     * this is for player 3 - Fast One
     */
    public static void main(String[] args) {
        // todo chapter 1 creation
        //  create yourself a new hero with an epic name (an instance of class Hero)
        //  your hero is really fast, so find a way to define Dexterity for your hero
        //  add dexterity to your hero
        ...
        // create a method to train dexterity (your teammates will create other methods)
